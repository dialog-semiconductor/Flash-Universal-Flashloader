...
static void fhc_assign_pins_to_gpio(void)
{
	...
	IOPCTL_PinMuxSet(IOPCTL, 1U, 19U, IOPCTL_FUNC0); //CS
	IOPCTL_PinMuxSet(IOPCTL, 1U, 18U, IOPCTL_FUNC0); //SCK
	IOPCTL_PinMuxSet(IOPCTL, 1U, 20U, IOPCTL_FUNC0); //DATA0
	IOPCTL_PinMuxSet(IOPCTL, 1U, 21U, IOPCTL_FUNC0); //DATA1
	IOPCTL_PinMuxSet(IOPCTL, 1U, 22U, IOPCTL_FUNC0); //DATA2
	IOPCTL_PinMuxSet(IOPCTL, 1U, 23U, IOPCTL_FUNC0); //DATA3
}
...
static void fhc_assign_pins_to_flexspi(void)
{
	...
	IOPCTL_PinMuxSet(IOPCTL, 1U, 19U, pin_config | IOPCTL_FUNC1); //CS
	IOPCTL_PinMuxSet(IOPCTL, 1U, 18U, pin_config | IOPCTL_FUNC1); //SCK
	IOPCTL_PinMuxSet(IOPCTL, 1U, 20U, pin_config | IOPCTL_FUNC1); //DATA0
	IOPCTL_PinMuxSet(IOPCTL, 1U, 21U, pin_config | IOPCTL_FUNC1); //DATA1
	IOPCTL_PinMuxSet(IOPCTL, 1U, 22U, pin_config | IOPCTL_FUNC1); //DATA2
	IOPCTL_PinMuxSet(IOPCTL, 1U, 23U, pin_config | IOPCTL_FUNC1); //DATA3 
}
...
uint32_t fhc_init(void)
{
	...
	CLKCTL0->FLEXSPIFCLKSEL = CLKCTL0_FLEXSPIFCLKSEL_SEL(AUX0_PLL);
	CLKCTL0->FLEXSPIFCLKDIV |= CLKCTL0_FLEXSPIFCLKDIV_RESET_MASK; /* Reset the divider counter */
	CLKCTL0->FLEXSPIFCLKDIV = CLKCTL0_FLEXSPIFCLKDIV_DIV((FLEXSPI_SRC_CLK_FREQ/flexspi_root_clk_freq) - 1);
